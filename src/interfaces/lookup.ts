...
export default {
  ...
  PrimitivesNftClassType: {
    _enum: ['Marketplace', 'LiquidityMining', 'Redeemable', 'Auction', 'HydraHeads']
  },
  /**
  ...
  PalletAssetRegistryError: {
    _enum: ['NoIdAvailable', 'AssetNotFound', 'TooLong', 'AssetNotRegistered', 'AssetAlreadyRegistered', 'InvalidSharedAssetLen', 'CannotUpdateLocation']
  },
  /**
   ...
   **/
  PalletExchangeError: {
    _enum: ['TokenPoolNotFound', 'InsufficientAssetBalance', 'TradeAmountExceededLimit', 'TradeAmountNotReachedLimit', 'ZeroSpotPrice', 'MinimumTradeLimitNotReached', 'IntentionCountOverflow']
  },
  /**
   ...
   **/
  PalletNftError: {
    _enum: ['NoAvailableInstanceId', 'NoAvailableClassId', 'TokenClassNotEmpty', 'ClassUnknown', 'InstanceUnknown', 'NotPermitted', 'IdReserved']
  },
  /**
  ...
  PalletMarketplaceError: {
    _enum: ['NotTheTokenOwner', 'BuyFromSelf', 'NotForSale', 'ClassOrInstanceUnknown', 'OfferTooLow', 'UnknownOffer', 'OfferExpired', 'AlreadyOffered', 'WithdrawNotAuthorized', 'AcceptNotAuthorized', 'RoyaltyAlreadySet', 'NotInRange']
  },
  /**
