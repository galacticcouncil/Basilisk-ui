  ...
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    authorship: {
      ...
      setUncles: AugmentedSubmittable<
        (newUncles: Vec<SpRuntimeHeader>) => SubmittableExtrinsic<ApiType>,
        [Vec<SpRuntimeHeader>]
      >
      /**
       * Generic tx
    ...
    collatorSelection: {
      ...
      setInvulnerables: AugmentedSubmittable<
        (updated: Vec<AccountId32>) => SubmittableExtrinsic<ApiType>,
        [Vec<AccountId32>]
      >
      /**
       * Generic tx
    ...
    democracy: {
      ...
      cancelProposal: AugmentedSubmittable<
        (propIndex: Compact<u32>) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>]
      >
      /**
      ...
      cancelReferendum: AugmentedSubmittable<
        (refIndex: Compact<u32>) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>]
      >
      /**
    ...
    elections: {
      ...
      submitCandidacy: AugmentedSubmittable<
        (candidateCount: Compact<u32>) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>]
      >
      /**
    ...
    identity: {
      ...
      setIdentity: AugmentedSubmittable<
        (info: PalletIdentityIdentityInfo) => SubmittableExtrinsic<ApiType>,
        [PalletIdentityIdentityInfo]
      >
      /**
      ...
      setSubs: AugmentedSubmittable<
        (
          subs: Vec<ITuple<[AccountId32, Data]>>,
        ) => SubmittableExtrinsic<ApiType>,
    ...
    lbp: {
      ...
      addLiquidity: AugmentedSubmittable<
        (
          amountA: ITuple<[u32, u128]>,
          amountB: ITuple<[u32, u128]>,
        ) => SubmittableExtrinsic<ApiType>,
    ...
    multisig: {
      ...
      asMulti: AugmentedSubmittable<
        (
          ...
          otherSignatories: Vec<AccountId32>,
          maybeTimepoint: Option<PalletMultisigTimepoint>,
          call: WrapperKeepOpaque<Call> | string | Uint8Array,
    ...
    polkadotXcm: {
      ...
      forceDefaultXcmVersion: AugmentedSubmittable<
        (maybeXcmVersion: Option<u32>) => SubmittableExtrinsic<ApiType>,
        [Option<u32>]
      >
      /**
      ...
      forceSubscribeVersionNotify: AugmentedSubmittable<
        (location: XcmVersionedMultiLocation) => SubmittableExtrinsic<ApiType>,
        [XcmVersionedMultiLocation]
      >
      /**
    ...
    session: {
      ...
      setKeys: AugmentedSubmittable<
        (
          keys: BasiliskRuntimeOpaqueSessionKeys,
    ...
    treasury: {
      ...
      approveProposal: AugmentedSubmittable<
        (proposalId: Compact<u32>) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>]
      >
      /**
    ...
    uniques: {
      ...
      clearClassMetadata: AugmentedSubmittable<
        (clazz: Compact<u128>) => SubmittableExtrinsic<ApiType>,
        [Compact<u128>]
      >
      /**
    ...
    utility: {
      ...
      batch: AugmentedSubmittable<
        (calls: Vec<Call>) => SubmittableExtrinsic<ApiType>,
        [Vec<Call>]
      >
      /**
    ...
    xTokens: {
      ...
      transferMulticurrencies: AugmentedSubmittable<
        (
          currencies: Vec<ITuple<[u32, u128]>>,
          feeItem: u32 | AnyNumber | Uint8Array,
          dest: XcmVersionedMultiLocation,
          destWeight: u64 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
