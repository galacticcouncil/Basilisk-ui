...
import {
  CommonRuntimeAssetLocation, FrameSupportTokensMiscBalanceStatus,
  PalletAssetRegistryAssetType, PalletDemocracyVoteAccountVote,
  PalletDemocracyVoteThreshold, PalletLbpPool, PrimitivesAssetAssetPair,
  PrimitivesIntentionType, SpRuntimeDispatchError,
  XcmV2TraitsOutcome,
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    nft: {
       ...
       * A class was created
       **/
      ClassCreated: AugmentedEvent<ApiType, [owner: AccountId32, classId: u128, classType: PrimitivesNftClassType], { owner: AccountId32, classId: u128, classType: PrimitivesNftClassType }>;
      /**
       ...
       **/
      InstanceMinted: AugmentedEvent<ApiType, [owner: AccountId32, classId: u128, instanceId: u128], { owner: AccountId32, classId: u128, instanceId: u128 }>;
      /**
