...
import type { CommonRuntimeAssetLocation, CommonRuntimeProxyType, FrameSupportScheduleLookupError, FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, OrmlVestingVestingSchedule, PalletAssetRegistryAssetType, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletLbpPool, PalletMultisigTimepoint, PrimitivesAssetAssetPair, PrimitivesIntentionType, PrimitivesNftClassType, SpRuntimeDispatchError, XcmV1MultiAsset, XcmV1MultiLocation, XcmV1MultiassetMultiAssets, XcmV2Response, XcmV2TraitsError, XcmV2TraitsOutcome, XcmV2Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetRegistry: {
       ...
       **/
      LocationSet: AugmentedEvent<ApiType, [assetId: u32, location: CommonRuntimeAssetLocation], { assetId: u32, location: CommonRuntimeAssetLocation }>;
      /**
    ...
    exchange: {
       ...
       **/
      InsufficientAssetBalanceEvent: AugmentedEvent<ApiType, [who: AccountId32, assetId: u32, intentionType: PrimitivesIntentionType, intentionId: H256, errorDetail: SpRuntimeDispatchError], { who: AccountId32, assetId: u32, intentionType: PrimitivesIntentionType, intentionId: H256, errorDetail: SpRuntimeDispatchError }>;
      /**
       * Intention registered event
       **/
      IntentionRegistered: AugmentedEvent<ApiType, [who: AccountId32, assetA: u32, assetB: u32, amount: u128, intentionType: PrimitivesIntentionType, intentionId: H256], { who: AccountId32, assetA: u32, assetB: u32, amount: u128, intentionType: PrimitivesIntentionType, intentionId: H256 }>;
      /**
       * Intention resolved as AMM Trade
       **/
      IntentionResolvedAMMTrade: AugmentedEvent<ApiType, [who: AccountId32, intentionType: PrimitivesIntentionType, intentionId: H256, amount: u128, amountSoldOrBought: u128, poolAccountId: AccountId32], { who: AccountId32, intentionType: PrimitivesIntentionType, intentionId: H256, amount: u128, amountSoldOrBought: u128, poolAccountId: AccountId32 }>;
      /**
       * Intention resolved as Direct Trade
       **/
      IntentionResolvedDirectTrade: AugmentedEvent<ApiType, [accountIdA: AccountId32, accountIdB: AccountId32, intentionIdA: H256, intentionIdB: H256, amountA: u128, amountB: u128], { accountIdA: AccountId32, accountIdB: AccountId32, intentionIdA: H256, intentionIdB: H256, amountA: u128, amountB: u128 }>;
      /**
       * Paid fees event
       **/
      IntentionResolvedDirectTradeFees: AugmentedEvent<ApiType, [who: AccountId32, intentionId: H256, feeReceiver: AccountId32, assetId: u32, feeAmount: u128], { who: AccountId32, intentionId: H256, feeReceiver: AccountId32, assetId: u32, feeAmount: u128 }>;
      /**
       * Intention Error Event
       **/
      IntentionResolveErrorEvent: AugmentedEvent<ApiType, [who: AccountId32, assetIds: PrimitivesAssetAssetPair, intentionType: PrimitivesIntentionType, intentionId: H256, errorDetail: SpRuntimeDispatchError], { who: AccountId32, assetIds: PrimitivesAssetAssetPair, intentionType: PrimitivesIntentionType, intentionId: H256, errorDetail: SpRuntimeDispatchError }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    nft: {
       ...
       * A class was created
       **/
      ClassCreated: AugmentedEvent<ApiType, [owner: AccountId32, classId: u128, classType: PrimitivesNftClassType, metadata: Bytes], { owner: AccountId32, classId: u128, classType: PrimitivesNftClassType, metadata: Bytes }>;
      /**
       * A class was destroyed
       **/
      ClassDestroyed: AugmentedEvent<ApiType, [owner: AccountId32, classId: u128], { owner: AccountId32, classId: u128 }>;
      /**
       * An instance was burned
       **/
      InstanceBurned: AugmentedEvent<ApiType, [owner: AccountId32, classId: u128, instanceId: u128], { owner: AccountId32, classId: u128, instanceId: u128 }>;
      /**
       * An instance was minted
       **/
      InstanceMinted: AugmentedEvent<ApiType, [owner: AccountId32, classId: u128, instanceId: u128, metadata: Bytes], { owner: AccountId32, classId: u128, instanceId: u128, metadata: Bytes }>;
      /**
       * An instance was transferred
       **/
      InstanceTransferred: AugmentedEvent<ApiType, [from: AccountId32, to: AccountId32, classId: u128, instanceId: u128], { from: AccountId32, to: AccountId32, classId: u128, instanceId: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
