...
import type { BTreeMap, Bytes, Compact, Enum, Null, Option, Result, Set, Struct, Text, U8aFixed, Vec, WrapperKeepOpaque, bool, i128, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/types/lookup' {
  ...
  interface CommonRuntimeProxyType extends Enum {
    ...
    readonly isTransfer: boolean;
    readonly type: 'Any' | 'CancelProxy' | 'Governance' | 'Exchange' | 'Transfer';
  }
  ...
  interface PalletExchangeEvent extends Enum {
    ...
    readonly type: 'IntentionRegistered' | 'IntentionResolvedAMMTrade' | 'IntentionResolvedDirectTrade' | 'IntentionResolvedDirectTradeFees' | 'InsufficientAssetBalanceEvent' | 'IntentionResolveErrorEvent';
  }
  ...
  interface PalletNftEvent extends Enum {
    ...
    readonly type: 'ClassCreated' | 'InstanceMinted' | 'InstanceTransferred' | 'InstanceBurned' | 'ClassDestroyed';
  }
  ...
  interface PrimitivesNftClassType extends Enum {
    ...
    readonly type: 'Marketplace' | 'LiquidityMining' | 'Redeemable' | 'Auction' | 'HydraHeads';
  }
  ...
  interface PalletMarketplaceEvent extends Enum {
    ...
    readonly type: 'TokenPriceUpdated' | 'TokenSold' | 'OfferPlaced' | 'OfferWithdrawn' | 'OfferAccepted' | 'RoyaltyPaid' | 'RoyaltyAdded';
  }
  ...
  interface PalletMarketplaceCall extends Enum {
    ...
    readonly type: 'Buy' | 'SetPrice' | 'MakeOffer' | 'WithdrawOffer' | 'AcceptOffer' | 'AddRoyalty';
  }
  ...
  interface PalletAssetRegistryError extends Enum {
    ...
    readonly type: 'NoIdAvailable' | 'AssetNotFound' | 'TooLong' | 'AssetNotRegistered' | 'AssetAlreadyRegistered' | 'InvalidSharedAssetLen' | 'CannotUpdateLocation';
  }
  ...
  interface PalletExchangeError extends Enum {
    ...
    readonly type: 'TokenPoolNotFound' | 'InsufficientAssetBalance' | 'TradeAmountExceededLimit' | 'TradeAmountNotReachedLimit' | 'ZeroSpotPrice' | 'MinimumTradeLimitNotReached' | 'IntentionCountOverflow';
  }
  ...
  interface PalletNftError extends Enum {
    ...
    readonly type: 'NoAvailableInstanceId' | 'NoAvailableClassId' | 'TokenClassNotEmpty' | 'ClassUnknown' | 'InstanceUnknown' | 'NotPermitted' | 'IdReserved';
  }
  ...
  interface PalletMarketplaceError extends Enum {
    ...
    readonly type: 'NotTheTokenOwner' | 'BuyFromSelf' | 'NotForSale' | 'ClassOrInstanceUnknown' | 'OfferTooLow' | 'UnknownOffer' | 'OfferExpired' | 'AlreadyOffered' | 'WithdrawNotAuthorized' | 'AcceptNotAuthorized' | 'RoyaltyAlreadySet' | 'NotInRange';
  }
