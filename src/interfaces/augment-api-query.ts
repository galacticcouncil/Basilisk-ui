  ...
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetRegistry: {
      ...
      locationAssets: AugmentedQuery<
        ApiType,
        (arg: CommonRuntimeAssetLocation) => Observable<Option<u32>>,
        [CommonRuntimeAssetLocation]
      > &
    ...
    exchange: {
      ...
      exchangeAssetsIntentionCount: AugmentedQuery<
        ApiType,
        (arg: ITuple<[u32, u32]>) => Observable<u32>,
        [ITuple<[u32, u32]>]
      > &
    ...
    polkadotXcm: {
      ...
      supportedVersion: AugmentedQuery<
        ...
        (
          ...
          arg2: XcmVersionedMultiLocation,
        ) => Observable<Option<u32>>,
    ...
    transactionPause: {
      ...
      pausedTransactions: AugmentedQuery<
        ApiType,
        (arg: ITuple<[Bytes, Bytes]>) => Observable<Option<Null>>,
        [ITuple<[Bytes, Bytes]>]
      > &
