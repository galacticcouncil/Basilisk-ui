...
import type { BasiliskRuntimeOpaqueSessionKeys, CommonRuntimeAssetLocation, CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, FrameSupportWeightsPerDispatchClassU64, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, OrmlTokensAccountData, OrmlTokensBalanceLock, OrmlVestingVestingSchedule, PalletAssetRegistryAssetDetails, PalletAssetRegistryAssetMetadata, PalletAuthorshipUncleEntryItem, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReleases, PalletBalancesReserveData, PalletCollatorSelectionCandidateInfo, PalletCollectiveVotes, PalletDemocracyPreimageStatus, PalletDemocracyReferendumInfo, PalletDemocracyReleases, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletElectionsPhragmenSeatHolder, PalletElectionsPhragmenVoter, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletLbpPool, PalletMarketplaceOffer, PalletMarketplaceRoyalty, PalletMultisigMultisig, PalletNftClassInfo, PalletNftInstanceInfo, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletSchedulerScheduledV3, PalletTipsOpenTip, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletUniquesClassDetails, PalletUniquesClassMetadata, PalletUniquesInstanceDetails, PalletUniquesInstanceMetadata, PalletXcmQueryStatus, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV1AbridgedHostConfiguration, PolkadotPrimitivesV1PersistedValidationData, PolkadotPrimitivesV1UpgradeRestriction, PrimitivesExchangeIntention, SpCoreCryptoKeyTypeId, SpRuntimeDigest, XcmV1MultiLocation, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    marketplace: {
       ...
       **/
      marketplaceInstances: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletMarketplaceRoyalty>>, [u128, u128]> & QueryableStorageEntry<ApiType, [u128, u128]>;
      /**
       * Stores offer info
       **/
    ...
    nft: {
       ...
       * Stores class info
       **/
      classes: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletNftClassInfo>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Stores instance info
       **/
      instances: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletNftInstanceInfo>>, [u128, u128]> & QueryableStorageEntry<ApiType, [u128, u128]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    uniques: {
       ...
       **/
      asset: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletUniquesInstanceDetails>>, [u128, u128]> & QueryableStorageEntry<ApiType, [u128, u128]>;
      /**
       ...
       **/
      class: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletUniquesClassDetails>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       * Metadata of an asset class.
       **/
      classMetadataOf: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletUniquesClassMetadata>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Metadata of an asset instance.
       **/
      instanceMetadataOf: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletUniquesInstanceMetadata>>, [u128, u128]> & QueryableStorageEntry<ApiType, [u128, u128]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
